  ...
  return (
    <div className="h-full flex flex-col bg-white border-r border-morning py-10 px-4">
      <div className="mb-12 flex justify-center px-6">
        <img src="/full-logo.svg" alt="ResearchCollab.ai" className="h-8 max-w-full" />
      </div>
      ...
      <nav className="flex-1 space-y-4">
        {items.map((item) => (
          <button
            ...
            className={`w-full p-4 flex flex-col items-center justify-center group transition-colors duration-200 rounded-lg ${currentView === item.view ? 'bg-silk' : 'hover:bg-silk/50'
              }`}
          >
            <svg
